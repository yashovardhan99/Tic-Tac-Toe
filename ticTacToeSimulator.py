...
from ticTacToe import getAIMove,makeAIMove,isWinner
import ticTacToeCenterFirstAI as altAI
NO_OF_GAMES = 1000 #Change as per requirement
...
for i in range(NO_OF_GAMES):
    ...
    while True:
        if moves>=9:
            ...
            break
        if current==0:
            makeAIMove(gameBoard,LETTERS[0])
            moves = moves+1
            current=1
